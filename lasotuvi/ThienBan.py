...
class lapThienBan:
    def __init__(self, nn, tt, nnnn, gioSinh, gioiTinh, ten, diaBan, duongLich=True, timeZone=7):
        ...
        self.gioSinh = "{} {}".format(thienCan[canGioSinh]["tenCan"], chiGioSinh["tenChi"])
        ...
        if duongLich is True:
            self.ngayAm, self.thangAm, self.namAm, self.thangNhuan = ngayThangNam(
                self.ngayDuong, self.thangDuong, self.namDuong, True, self.timeZone
            )
        else:
            self.ngayAm, self.thangAm, self.namAm = self.ngayDuong, self.thangDuong, self.namDuong

        self.canThang, self.canNam, self.chiNam = ngayThangNamCanChi(
            self.ngayAm, self.thangAm, self.namAm, False, self.timeZone
        )
        ...
        self.canNgay, self.chiNgay = canChiNgay(
            self.ngayDuong, self.thangDuong, self.namDuong, duongLich, timeZone
        )
